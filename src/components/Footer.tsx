...
export default function Footer() {
  ...
  return (
    // UPDATED: bg-transparent & subtle border
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-10">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-500 font-medium">Full Stack Developer</p>
          </div>
        ...
        <div className="pt-8 border-t border-gray-200/50 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium">
          ...
          <motion.div 
            className="flex items-center gap-1.5 text-gray-500 dark:text-gray-500 bg-white/40 dark:bg-white/5 px-3 py-1.5 rounded-full border border-gray-200/50 dark:border-white/5 backdrop-blur-sm"
