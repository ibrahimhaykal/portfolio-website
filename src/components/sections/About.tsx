...
export default function About() {
  ...
  return (
    // UPDATED: bg-transparent to show global grid pattern
    <section id="about" className="py-20 bg-transparent">
      <div className="max-w-4xl mx-auto px-6">
        ...
        {/* Story Card - UPDATED: Glassmorphism */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          ...
          <div className="flex items-center gap-2 text-sm font-medium">
            ...
            <span className="text-gray-600 dark:text-gray-400">
              Looking for <span className="text-sky-600 dark:text-sky-400">IT Operations Specialist</span> or <span className="text-sky-600 dark:text-sky-400">Backend Developer</span> roles.
            </span>
          </div>
        </motion.div>

        {/* Stats Grid - UPDATED: Transparent & Clean */}
        ...
        {/* Tech Stack Grid - UPDATED: Clean Grid */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
